"""
Django settings for teset project.
...
SECRET_KEY = 'django-insecure-peg1ayq+yu*-(famk_dm5mw9txhths^k^bg(cx=541kna8sjis'
...
WSGI_APPLICATION = 'teset.wsgi.application'
